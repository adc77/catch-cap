...
from services.searxng_service import SearXNGClient
from services.browsing_agent import BrowsingAgent
...
class IntelligentWebSearchTool:
    ...
    async def _generate_answer(self, query: str, relevant_results: List) -> str:
        ...
        - Do not add "Based on the provided web content" in the response
